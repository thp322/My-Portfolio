...
const COPY = {
  en: {
    title: 'About Harper',
    paragraphs: [
      "I’m Harper‑Tang Haiping, a coding enthusiast roaming the realm of code. I explore the unfamiliar, dig into emerging tech, and chase uncharted technical frontiers.",
    ],
  },
  zh: {
    title: 'About Harper',
    ...
    <>
      ...
      <motion.div className="hero-chrome" style={{ opacity: heroChromeOpacity }} aria-hidden="true">
        ...
        <div className="hero-meta hm-tl">
          <span className="hm-name">Harper 唐海平</span>
